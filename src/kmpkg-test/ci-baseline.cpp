...
# script ports
#kmpkg-cmake:arm64-windows=fail
#kmpkg-cmake:arm-uwp=fail
#kmpkg-cmake:x64-uwp=fail
#kmpkg-cmake:x64-windows-static=fail
#kmpkg-cmake:x64-windows-static-md=fail
#kmpkg-cmake:x86-windows=fail

#kmpkg-cmake-config:arm64-windows=fail
#kmpkg-cmake-config:arm-uwp=fail
#kmpkg-cmake-config:x64-uwp=fail
#kmpkg-cmake-config:x64-windows-static=fail
#kmpkg-cmake-config:x64-windows-static-md=fail
#kmpkg-cmake-config:x86-windows=fail
...
kmpkg-ci-opencv:arm64-windows=pass

aubio:arm-uwp=fail
aubio:x64-uwp=fail
# broken when `python` is python3, https://github.com/kumose/kmpkg/issues/18937
bde:x64-linux=fail
...
bill-made-up-another-skip:x64-linux=skip)"; // note no trailing newline
    ...
    std::vector<CiBaselineLine> expected_from_example_input{
        ...
        CiBaselineLine{"kmpkg-ci-opencv", arm64_windows, CiBaselineState::Pass},
