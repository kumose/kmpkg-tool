...
TEST_CASE ("parse_git_ls_tree_output", "[git]")
{
    static constexpr StringLiteral test_data =
        StringLiteral{"100644 blob d0c3b3e9ccf66ddf0f30f2ac9a8a7f310c45b3d1\t.gitattributes\0"
                      ...
                      "100644 blob e69de29bb2d1d6434b8b29ae775ad8c2e48c5391\t.kmpkg-root\0"
                      ...
                      "100644 blob 54e0b85a225030ab1a9e0096cdb6f637ee84c326\tbootstrap-kmpkg.bat\0"
                      "100755 blob 7165a725fd719883b614e6e90a95179dcd5a1817\tbootstrap-kmpkg.sh\0"
    ...
    std::vector<GitLSTreeEntry> expected = {
        ...
        {StringLiteral{".kmpkg-root"}, StringLiteral{"e69de29bb2d1d6434b8b29ae775ad8c2e48c5391"}},
        ...
        {StringLiteral{"bootstrap-kmpkg.bat"}, StringLiteral{"54e0b85a225030ab1a9e0096cdb6f637ee84c326"}},
        {StringLiteral{"bootstrap-kmpkg.sh"}, StringLiteral{"7165a725fd719883b614e6e90a95179dcd5a1817"}},
...
TEST_CASE ("parse_git_diff_tree_line", "[git]")
{
    ...
    REQUIRE(parse_git_diff_tree_lines(bdc, "git diff-tree", test_data.substr(0, test_data.size() - 1))
                .value_or_exit(KMPKG_LINE_INFO) == test_out);
    REQUIRE(bdc.empty());
}
