...
{
    REQUIRE(format_version_for_feedref("0.0.0", "abitag") == "0.0.0-kmpkgabitag");
    REQUIRE(format_version_for_feedref("1.0.1", "abitag") == "1.0.1-kmpkgabitag");
    REQUIRE(format_version_for_feedref("1.01.000", "abitag") == "1.1.0-kmpkgabitag");
    REQUIRE(format_version_for_feedref("1.2", "abitag") == "1.2.0-kmpkgabitag");
    REQUIRE(format_version_for_feedref("v52", "abitag") == "52.0.0-kmpkgabitag");
    REQUIRE(format_version_for_feedref("v09.01.02", "abitag") == "9.1.2-kmpkgabitag");
    REQUIRE(format_version_for_feedref("1.1.1q", "abitag") == "1.1.1-kmpkgabitag");
    REQUIRE(format_version_for_feedref("1", "abitag") == "1.0.0-kmpkgabitag");
}

TEST_CASE ("format_version_for_feedref date", "[format_version_for_feedref]")
{
    REQUIRE(format_version_for_feedref("2020-06-26", "abitag") == "2020.6.26-kmpkgabitag");
    REQUIRE(format_version_for_feedref("20-06-26", "abitag") == "0.0.0-kmpkgabitag");
    REQUIRE(format_version_for_feedref("2020-06-26-release", "abitag") == "2020.6.26-kmpkgabitag");
    REQUIRE(format_version_for_feedref("2020-06-26000", "abitag") == "2020.6.26-kmpkgabitag");
}

TEST_CASE ("format_version_for_feedref generic", "[format_version_for_feedref]")
{
    REQUIRE(format_version_for_feedref("apr", "abitag") == "0.0.0-kmpkgabitag");
    REQUIRE(format_version_for_feedref("", "abitag") == "0.0.0-kmpkgabitag");
}
...
Build-Depends: bzip
    ...
    REQUIRE(ref2.nupkg_filename() == "prefix_zlib2_x64-windows.1.5.0-kmpkgpackageabi.nupkg");

    FeedReference ref = make_nugetref(ipa, "");

    REQUIRE(ref.nupkg_filename() == "zlib2_x64-windows.1.5.0-kmpkgpackageabi.nupkg");

    REQUIRE_LINES(generate_nuspec(pkgPath, ipa, "", {}),
                  R"(<package>
  <metadata>
    <id>zlib2_x64-windows</id>
    <version>1.5.0-kmpkgpackageabi</version>
...
Dependencies:
    ...
    <packageTypes><packageType name="kmpkg"/></packageTypes>
  </metadata>
  <files><file src=")" +
                      pkgPathWild +
                      R"(" target=""/></files>
...
Description: a spiffy compression library wrapper
    ...
    REQUIRE(packageconfig == R"(<?xml version="1.0" encoding="utf-8"?>
<packages>
  <package id="zlib_x64-android" version="1.5.0-kmpkgpackageabi"/>
</packages>
)");
...
<packages>
  <package id="zlib_x64-android" version="1.5.0-kmpkgpackageabi"/>
  <package id="zlib2_x64-android" version="1.52.0-kmpkgpackageabi2"/>
</packages>
)");
}
