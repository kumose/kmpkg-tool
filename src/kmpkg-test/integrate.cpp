...
if [ -f "$HOME/.profile" ]; then
    ...
    const std::string source_line_1 = "source /blah/bloop/scripts/kmpkg_completion.bash";
    const std::string source_line_2 = "source /floop/scripts/kmpkg_completion.bash";
    ...
    CHECK(get_bash_source_completion_lines("source nonrelated/kmpkg_completion.bash") == std::vector<std::string>{});
    CHECK(get_bash_source_completion_lines("  source /scripts/kmpkg_completion.bash") ==
          std::vector<std::string>{"source /scripts/kmpkg_completion.bash"});

    CHECK(get_bash_source_completion_lines("#source /scripts/kmpkg_completion.bash") == std::vector<std::string>{});

    CHECK(get_bash_source_completion_lines("mysource /scripts/kmpkg_completion.bash") == std::vector<std::string>{});
}
...
. "$HOME/.cargo/env"
    ...
    const std::string source_line_1 = "source /blah/bloop/scripts/kmpkg_completion.zsh";
    const std::string source_line_2 = "source /floop/scripts/kmpkg_completion.zsh";
    const std::string bash_source_line = "source /scripts/kmpkg_completion.bash";
