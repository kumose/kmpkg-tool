...
#include <kmpkg-test/mockcmakevarprovider.h>
...
struct MockVersionedPortfileProvider : IVersionedPortfileProvider
{
    ...
    ExpectedL<const SourceControlFileAndLocation&> get_control_file(
        const kmpkg::VersionSpec& versionspec) const override
    {
    ...
    ExpectedL<const SourceControlFileAndLocation&> get_control_file(const std::string& name,
                                                                    const kmpkg::Version& version) const
    {
        auto it = v.find(name);
                ...
                version_map
                    .emplace(std::move(version),
                             SourceControlFileAndLocation{
                                 std::move(scf), Path(std::move(name)) / "kmpkg.json", spdx_location.to_string(), kind})
                    .first;
        }
...
{
    auto actual_version = maybe_version.value_or_exit(KMPKG_LINE_INFO);
...
TEST_CASE ("version sort semver", "[versionplan]")
{
    std::vector<DotVersion> versions{
        DotVersion::try_parse_semver("1.0.0").value_or_exit(KMPKG_LINE_INFO),
        DotVersion::try_parse_semver("0.0.0").value_or_exit(KMPKG_LINE_INFO),
        DotVersion::try_parse_semver("1.1.0").value_or_exit(KMPKG_LINE_INFO),
        DotVersion::try_parse_semver("2.0.0").value_or_exit(KMPKG_LINE_INFO),
        DotVersion::try_parse_semver("1.1.1").value_or_exit(KMPKG_LINE_INFO),
        DotVersion::try_parse_semver("1.0.1").value_or_exit(KMPKG_LINE_INFO),
        DotVersion::try_parse_semver("1.0.0-alpha.1").value_or_exit(KMPKG_LINE_INFO),
        DotVersion::try_parse_semver("1.0.0-beta").value_or_exit(KMPKG_LINE_INFO),
        DotVersion::try_parse_semver("1.0.0-alpha").value_or_exit(KMPKG_LINE_INFO),
        DotVersion::try_parse_semver("1.0.0-alpha.beta").value_or_exit(KMPKG_LINE_INFO),
        DotVersion::try_parse_semver("1.0.0-rc").value_or_exit(KMPKG_LINE_INFO),
        DotVersion::try_parse_semver("1.0.0-beta.2").value_or_exit(KMPKG_LINE_INFO),
        DotVersion::try_parse_semver("1.0.0-beta.20").value_or_exit(KMPKG_LINE_INFO),
        DotVersion::try_parse_semver("1.0.0-beta.3").value_or_exit(KMPKG_LINE_INFO),
        DotVersion::try_parse_semver("1.0.0-1").value_or_exit(KMPKG_LINE_INFO),
        DotVersion::try_parse_semver("1.0.0-0alpha").value_or_exit(KMPKG_LINE_INFO),
    };
...
{
    std::vector<DotVersion> versions{
        DotVersion::try_parse_relaxed("2.1-alpha.alpha").value_or_exit(KMPKG_LINE_INFO),
        DotVersion::try_parse_relaxed("1.0.0").value_or_exit(KMPKG_LINE_INFO),
        DotVersion::try_parse_relaxed("2.0-1").value_or_exit(KMPKG_LINE_INFO),
        DotVersion::try_parse_relaxed("1.0").value_or_exit(KMPKG_LINE_INFO),
        DotVersion::try_parse_relaxed("1").value_or_exit(KMPKG_LINE_INFO),
        DotVersion::try_parse_relaxed("2.1-alpha").value_or_exit(KMPKG_LINE_INFO),
        DotVersion::try_parse_relaxed("2").value_or_exit(KMPKG_LINE_INFO),
        DotVersion::try_parse_relaxed("1.1").value_or_exit(KMPKG_LINE_INFO),
        DotVersion::try_parse_relaxed("1.10.1").value_or_exit(KMPKG_LINE_INFO),
        DotVersion::try_parse_relaxed("2.0-0").value_or_exit(KMPKG_LINE_INFO),
        DotVersion::try_parse_relaxed("1.0.1").value_or_exit(KMPKG_LINE_INFO),
        DotVersion::try_parse_relaxed("2.1-beta").value_or_exit(KMPKG_LINE_INFO),
        DotVersion::try_parse_relaxed("1.0.0.1").value_or_exit(KMPKG_LINE_INFO),
        DotVersion::try_parse_relaxed("1.0.0.2").value_or_exit(KMPKG_LINE_INFO),
        DotVersion::try_parse_relaxed("2.0").value_or_exit(KMPKG_LINE_INFO),
        DotVersion::try_parse_relaxed("2.0-rc").value_or_exit(KMPKG_LINE_INFO),
    };
...
TEST_CASE ("version sort date", "[versionplan]")
{
    std::vector<DateVersion> versions{
        DateVersion::try_parse("2021-01-01.2").value_or_exit(KMPKG_LINE_INFO),
        DateVersion::try_parse("2021-01-01.1").value_or_exit(KMPKG_LINE_INFO),
        DateVersion::try_parse("2021-01-01.1.1").value_or_exit(KMPKG_LINE_INFO),
        DateVersion::try_parse("2021-01-01.1.0").value_or_exit(KMPKG_LINE_INFO),
        DateVersion::try_parse("2021-01-01").value_or_exit(KMPKG_LINE_INFO),
        DateVersion::try_parse("2021-01-01").value_or_exit(KMPKG_LINE_INFO),
        DateVersion::try_parse("2020-12-25").value_or_exit(KMPKG_LINE_INFO),
        DateVersion::try_parse("2020-12-31").value_or_exit(KMPKG_LINE_INFO),
        DateVersion::try_parse("2021-01-01.10").value_or_exit(KMPKG_LINE_INFO),
    };
...
TEST_CASE ("version install qualified dependencies", "[versionplan]")
{
    ...
    {
        MockCMakeVarProvider var_provider;
        var_provider.dep_info_vars[toplevel_spec()] = {{"KMPKG_CMAKE_SYSTEM_NAME", "Windows"}};
    ...
    {
        MockCMakeVarProvider var_provider;
        var_provider.dep_info_vars[toplevel_spec()] = {{"KMPKG_CMAKE_SYSTEM_NAME", "Linux"}};
...
TEST_CASE ("version install different vars", "[versionplan]")
{
    ...
    MockCMakeVarProvider var_provider;
    var_provider.dep_info_vars[PackageSpec{"a", Test::X86_WINDOWS}] = {{"KMPKG_CMAKE_SYSTEM_NAME", "Linux"}};
...
TEST_CASE ("version install host tool", "[versionplan]")
{
    ...
    SECTION ("normal toplevel")
    {
        ...
        auto install_plan = create_versioned_install_plan(vp, bp, {dep_c}).value_or_exit(KMPKG_LINE_INFO);
...
TEST_CASE ("respect supports expression", "[versionplan]")
{
    ...
    const auto supports_expression =
        parse_platform_expression("windows", MultipleBinaryOperators::Deny).value_or_exit(KMPKG_LINE_INFO);
    MockBaselineProvider bp;
    bp.v["a"] = {"1", 0};
    ...
    vp.emplace("a", {"1", 1});
    MockCMakeVarProvider var_provider;
    var_provider.dep_info_vars[{"a", toplevel_spec().triplet()}]["KMPKG_CMAKE_SYSTEM_NAME"] = "";
    auto install_plan = create_versioned_install_plan(vp, bp, {{"a", {}}}, var_provider);
    CHECK(install_plan.has_value());
    var_provider.dep_info_vars[{"a", toplevel_spec().triplet()}]["KMPKG_CMAKE_SYSTEM_NAME"] = "Linux";
...
TEST_CASE ("respect platform expressions in DependencyRequestedFeature", "[versionplan]")
{
    ...
    MockCMakeVarProvider var_provider;
    Dependency dep{
        "a", {{"x", parse_platform_expression("linux", MultipleBinaryOperators::Deny).value_or_exit(KMPKG_LINE_INFO)}}};

    SECTION ("on windows")
    {
        var_provider.dep_info_vars[toplevel_spec()]["KMPKG_CMAKE_SYSTEM_NAME"] = "";
        auto maybe_install_plan = create_versioned_install_plan(vp, bp, {dep}, var_provider);
        CHECK(maybe_install_plan.has_value());
        auto& install_plan = maybe_install_plan.value_or_exit(KMPKG_LINE_INFO);
...
TEST_CASE ("respect platform expressions in default features", "[versionplan]")
{
    ...
    MockVersionedPortfileProvider vp;
    {
        ...
        scf->core_paragraph->default_features.push_back(
            {"x", parse_platform_expression("linux", MultipleBinaryOperators::Deny).value_or_exit(KMPKG_LINE_INFO)});
    }
    ...
    SECTION ("on windows")
    {
        var_provider.dep_info_vars[spec]["KMPKG_CMAKE_SYSTEM_NAME"] = "";
        auto maybe_install_plan = create_versioned_install_plan(vp, bp, {dep}, var_provider);
        CHECK(maybe_install_plan.has_value());
        auto& install_plan = maybe_install_plan.value_or_exit(KMPKG_LINE_INFO);
        CHECK(install_plan.install_actions.size() == 1);
    ...
    SECTION ("on linux")
    {
        var_provider.dep_info_vars[spec]["KMPKG_CMAKE_SYSTEM_NAME"] = "Linux";
        auto maybe_install_plan = create_versioned_install_plan(vp, bp, {dep}, var_provider);
        CHECK(maybe_install_plan.has_value());
        auto& install_plan = maybe_install_plan.value_or_exit(KMPKG_LINE_INFO);
        CHECK(install_plan.install_actions.size() == 1);
...
TEST_CASE ("formatting plan 1", "[dependencies]")
{
    ...
    status_paragraphs.push_back(kmpkg::Test::make_status_pgh("d"));
    status_paragraphs.push_back(kmpkg::Test::make_status_pgh("e"));
    ...
    auto& scfl_f = vp.emplace("f",
                              {"1", 0},
                              PortSourceKind::Git,
                              "git+https://github.com/kumose/kmpkg:f54a99d43e600ceea175205850560f6dd37ea6cf");
    ...
    InstallPlanAction already_installed_d(
        status_db.get_installed_package_view({"d", Test::X86_WINDOWS}).value_or_exit(KMPKG_LINE_INFO),
        RequestType::AUTO_SELECTED,
        UseHeadVersion::No,
        Editable::No);
    REQUIRE(already_installed_d.display_name() == "d:x86-windows@1");
    InstallPlanAction already_installed_e(
        status_db.get_installed_package_view({"e", Test::X86_WINDOWS}).value_or_exit(KMPKG_LINE_INFO),
    ...
    REQUIRE_LINES(format_plan(plan).all_text(),
                  ...
                  "    f:x64-osx@1 -- git+https://github.com/kumose/kmpkg:f54a99d43e600ceea175205850560f6dd37ea6cf\n"
                  "The following packages are already installed:\n"
                  "  * d:x86-windows@1\n"
                  "    e:x86-windows@1\n"
                  "The following packages will be rebuilt:\n"
...
TEST_CASE ("dependency graph API snapshot: host and target")
{
    ...
    auto v = KmpkgCmdArguments::create_from_arg_sequence(nullptr, nullptr);
    v.imbue_from_fake_environment(envmap);
    auto s = create_dependency_graph_snapshot(v, plan);

    CHECK(s.has_value());
    auto obj = *s.get();
    auto version = obj.get("version")->integer(KMPKG_LINE_INFO);
    auto job = obj.get("job")->object(KMPKG_LINE_INFO);
    auto id = job.get("id")->string(KMPKG_LINE_INFO);
    auto correlator = job.get("correlator")->string(KMPKG_LINE_INFO);
    auto sha = obj.get("sha")->string(KMPKG_LINE_INFO);
    auto ref = obj.get("ref")->string(KMPKG_LINE_INFO);
    auto detector = obj.get("detector")->object(KMPKG_LINE_INFO);
    auto name = detector.get("name")->string(KMPKG_LINE_INFO);
    auto detector_version = detector.get("version")->string(KMPKG_LINE_INFO);
    auto url = detector.get("url")->string(KMPKG_LINE_INFO);
    auto manifests = obj.get("manifests")->object(KMPKG_LINE_INFO);
    auto manifest1 = manifests.get("kmpkg.json")->object(KMPKG_LINE_INFO);
    auto name1 = manifest1.get("name")->string(KMPKG_LINE_INFO);
    auto resolved1 = manifest1.get("resolved")->object(KMPKG_LINE_INFO);
    auto dependency_a_host = resolved1.get("pkg:github/kmpkg/a:x64-windows@1")->object(KMPKG_LINE_INFO);
    auto package_url_a_host = dependency_a_host.get("package_url")->string(KMPKG_LINE_INFO);
    auto relationship_a_host = dependency_a_host.get("relationship")->string(KMPKG_LINE_INFO);
    auto dependencies_a_host = dependency_a_host.get("dependencies")->array(KMPKG_LINE_INFO);
    auto dependency_a = resolved1.get("pkg:github/kmpkg/a:x86-windows@1")->object(KMPKG_LINE_INFO);
    auto package_url_a = dependency_a.get("package_url")->string(KMPKG_LINE_INFO);
    auto relationship_a = dependency_a.get("relationship")->string(KMPKG_LINE_INFO);
    auto dependencies_a = dependency_a.get("dependencies")->array(KMPKG_LINE_INFO);
    ...
    CHECK(url == "https://github.com/kumose/kmpkg");
    CHECK(name1 == "kmpkg.json");
    CHECK(package_url_a_host == "pkg:github/kmpkg/a:x64-windows@1");
    CHECK(relationship_a_host == "direct");
    CHECK(dependencies_a_host.size() == 0);
    CHECK(package_url_a == "pkg:github/kmpkg/a:x86-windows@1");
