...
namespace
{
    void do_print_json(std::vector<const kmpkg::SourceControlFile*> source_control_files)
    {
        Json::Object obj;
        ...
        else
        {
            ...
            msg::write_unlocalized_text_to_stdout(Color::none,
                                                  fmt::format("{1:{0}} {3:{2}} {4}\n",
                                                              ...
                                                              ver_size,
                                                              full_version,
                                                              kmpkg::shorten_text(description, description_size)));
        }
    }
        ...
        else
        {
            ...
            msg::write_unlocalized_text_to_stdout(Color::none,
                                                  fmt::format("{1:{0}} {2}\n",
                                                              ...
                                                              full_feature_name,
                                                              kmpkg::shorten_text(description, desc_length)));
        }
    }
    ...
    void perform_find_artifact_and_exit(const KmpkgPaths& paths,
                                        ...
                                        Optional<StringView> version)
    {
        ...
        Checks::exit_with_code(KMPKG_LINE_INFO, run_configure_environment_command(paths, ce_args));
    }
} // unnamed namespace
...
namespace kmpkg
{
    ...
    {
        Checks::check_exit(KMPKG_LINE_INFO, msg::default_output_stream == OutputStream::StdErr);
    ...
    void command_find_and_exit(const KmpkgCmdArguments& args, const KmpkgPaths& paths)
    {
        ...
        if (selector == "port")
        {
            ...
            {
                Checks::msg_exit_with_error(KMPKG_LINE_INFO, msgFindVersionArtifactsOnly);
            }
