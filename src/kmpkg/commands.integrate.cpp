...
<Project ToolsVersion="4.0" xmlns="http://schemas.microsoft.com/developer/msbuild/2003">
  ...
  <Target Name="CheckValidPlatform" BeforeTargets="Build">
    <Error Text="Unsupported architecture combination. Remove the 'kmpkg' nuget package." Condition="'$(KMPkgEnabled)' != 'true' and '$(PkgDisableError)' == ''"/>
  </Target>
</Project>
)###",
...
<package>
    ...
    constexpr CommandMetadata CommandIntegrateMetadata{
        ...
        "https://pub.kumose.cc/kmpkg/commands/integrate",
