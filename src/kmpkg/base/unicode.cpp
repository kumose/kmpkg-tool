...
namespace kmpkg::Unicode
{
    int utf8_encode_code_point(char (&array)[4], char32_t code_point) noexcept
    {
        ...
        kmpkg::Checks::msg_exit_with_message(
            KMPKG_LINE_INFO,
    ...
    {
        kmpkg::Checks::check_exit(KMPKG_LINE_INFO, utf16_is_leading_surrogate_code_point(leading));
        kmpkg::Checks::check_exit(KMPKG_LINE_INFO, utf16_is_trailing_surrogate_code_point(trailing));
