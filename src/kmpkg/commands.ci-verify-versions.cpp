...
#include <kmpkg/commands.ci-verify-versions.h>
...
namespace
{
                         ...
                         const GitVersionDbEntry& version_entry)
    {
        ...
        if (!scfl)
        {
            ...
            // path, like this:
            //
            // C:\Dev\kmpkg\versions\a-\abseil.json:
            // C:\Dev\kmpkg\buildtrees\versioning_\versions\abseil\28fa609b06eec70bb06e61891e94b94f35f7d06e\kmpkg.json:
            ...
            errors_sink.println(Color::error,
                                LocalizedString::from_raw(scfl.control_path)
                                    ...
                                    .append(msgVersionDatabaseFileMissing3,
                                            msg::command_line = fmt::format("kmpkg x-add-version {}", port_name)));
            return success;
        }
        ...
        if (version_entry.version.scheme != local_port_version.scheme)
        {
            ...
            errors_sink.println(
                ...
                LocalizedString::from_raw(versions_database_entry.versions_file_path)
                    ...
                    .append_raw(fmt::format("\nkmpkg x-add-version {} --overwrite-version", port_name)));
        }
        ...
        if (local_git_tree != version_entry.git_tree)
        {
            ...
            errors_sink.println(Color::error,
                                LocalizedString::from_raw(versions_database_entry.versions_file_path)
                                    ...
                                    .append_raw('\n')
                                    .append_indent()
                                    .append_raw(fmt::format("kmpkg x-add-version {}\n", port_name))
                                    .append_indent()
                                    ...
                                    .append_raw('\n')
                                    .append_indent()
                                    .append_raw(fmt::format("kmpkg x-add-version {} --overwrite-version\n", port_name))
                                    .append_indent()
                                    .append_raw("git add versions\n")
                                    .append_indent()
                                    .append(msgGitCommitUpdateVersionDatabase));
...
namespace kmpkg
{
    ...
    void command_ci_verify_versions_and_exit(const KmpkgCmdArguments& args, const KmpkgPaths& paths)
    {
        ...
        auto versions_database =
            load_all_git_versions_files(fs, paths.builtin_registry_versions).value_or_exit(KMPKG_LINE_INFO);
        auto baseline = get_builtin_baseline(paths).value_or_exit(KMPKG_LINE_INFO);
