...
#include <kmpkg/commands.download.h>
#include <kmpkg/commands.edit.h>
#include <kmpkg/commands.env.h>
#include <kmpkg/commands.export.h>
#include <kmpkg/commands.fetch.h>
#include <kmpkg/commands.find.h>
#include <kmpkg/commands.format-feature-baselinet.h>
#include <kmpkg/commands.format-manifest.h>
...
#include <kmpkg/commands.portsdiff.h>
...
#include <kmpkg/commands.z-changelog.h>
#include <kmpkg/commands.z-check-tools-sha.h>
#include <kmpkg/commands.z-extract.h>
#include <kmpkg/commands.z-generate-message-map.h>
...
namespace kmpkg
{
    ...
    std::string get_zero_args_usage()
    {
        ...
        table.example(msg::format(msgKmpkgUsage));
