...
Download and install {fmt} using the kmpkg package manager:

    git clone https://github.com/Microsoft/kmpkg.git
    cd kmpkg
    ./bootstrap-kmpkg.sh
    ./kmpkg integrate install
    ./kmpkg install fmt

<!-- The fmt package in kmpkg is kept up to date by Microsoft team members and
community contributors. If the version is out of date, please [create an
issue or pull request](https://github.com/Microsoft/kmpkg) on the kmpkg
repository. -->
