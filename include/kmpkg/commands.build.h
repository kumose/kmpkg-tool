...
#include <kmpkg/fwd/binarycaching.h>
...
namespace kmpkg
{
    ...
    {
        virtual void record_build_result(const KmpkgPaths& paths,
    ...
    void purge_packages_dirs(const KmpkgPaths& paths, const ActionKindVector& actions)
    {
    ...
    struct PreBuildInfo
    {
        PreBuildInfo(const KmpkgPaths& paths,
                     Triplet triplet,
    ...
    struct ExtendedBuildResult
    {
        ...
        explicit ExtendedBuildResult(BuildResult code, kmpkg::Path stdoutlog, std::vector<std::string>&& error_logs);
    ...
    struct EnvCache
    {
        ...
        const Environment& get_action_env(const KmpkgPaths& paths,
                                          const PreBuildInfo& pre_build_info,
                                          const Toolset& toolset);
        const std::string& get_triplet_info(const KmpkgPaths& paths,
                                            const PreBuildInfo& pre_build_info,
                                            const Toolset& toolset);
        const CompilerInfo& get_compiler_info(const KmpkgPaths& paths,
                                              const PreBuildInfo& pre_build_info,
                                              const Toolset& toolset);
    ...
    private:
        ...
        struct EnvMapEntry
        {
            ...
            Cache<kmpkg::Command, Environment, CommandLess> cmd_cache;
        };
