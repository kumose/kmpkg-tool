...
namespace kmpkg
{
    ...
    // this is for version parsing that isn't in kmpkg ports
...
KMPKG_FORMAT_WITH_TO_STRING(kmpkg::Version);
KMPKG_FORMAT_WITH_TO_STRING(kmpkg::VersionDiff);
KMPKG_FORMAT_WITH_TO_STRING_LITERAL_NONMEMBER(kmpkg::VersionScheme);
KMPKG_FORMAT_WITH_TO_STRING(kmpkg::VersionSpec);
