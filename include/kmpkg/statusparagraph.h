...
#include <kmpkg/fwd/statusparagraph.h>
...
KMPKG_FORMAT_WITH_TO_STRING_LITERAL_NONMEMBER(kmpkg::InstallState);
KMPKG_FORMAT_WITH_TO_STRING_LITERAL_NONMEMBER(kmpkg::Want);
KMPKG_FORMAT_WITH_TO_STRING(kmpkg::StatusLine);
