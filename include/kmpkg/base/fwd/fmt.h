...
#define KMPKG_FORMAT_AS(Type, Base)                                                                                    \
    template<typename Char>                                                                                            \
...
#define KMPKG_FORMAT_WITH_TO_STRING(Type)                                                                              \
    template<typename Char>                                                                                            \
...
#define KMPKG_FORMAT_WITH_TO_STRING_LITERAL_NONMEMBER(Type)                                                            \
    template<typename Char>                                                                                            \
    struct fmt::formatter<Type, Char, void> : fmt::formatter<kmpkg::StringLiteral, Char, void>                         \
    {                                                                                                                  \
        template<typename FormatContext>                                                                               \
        auto format(Type const& val, FormatContext& ctx) const -> decltype(ctx.out())                                  \
        {                                                                                                              \
            return fmt::formatter<kmpkg::StringLiteral, Char, void>::format(to_string_literal(val), ctx);              \
        }                                                                                                              \
    }
