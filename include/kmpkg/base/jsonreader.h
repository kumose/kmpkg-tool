...
namespace kmpkg::Json
{
    ...
    Optional<Type> IDeserializer<Type>::visit(Reader& r, const Value& value) const
    {
        switch (value.kind())
        {
            ...
            case ValueKind::Boolean: return visit_boolean(r, value.boolean(KMPKG_LINE_INFO));
            case ValueKind::Integer: return visit_integer(r, value.integer(KMPKG_LINE_INFO));
            case ValueKind::Number: return visit_number(r, value.number(KMPKG_LINE_INFO));
            case ValueKind::String: return visit_string(r, value.string(KMPKG_LINE_INFO));
            case ValueKind::Array: return visit_array(r, value.array(KMPKG_LINE_INFO));
            case ValueKind::Object:
                return visit(r, value.object(KMPKG_LINE_INFO)); // Call `visit` to get unexpected fields checking
