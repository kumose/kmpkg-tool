...
template<class Char>
struct fmt::range_format_kind<kmpkg::StringView, Char>
    : std::integral_constant<fmt::range_format, fmt::range_format::disabled>
{
};

template<class Char>
struct fmt::formatter<kmpkg::StringView, Char, void> : fmt::formatter<fmt::basic_string_view<char>, Char, void>
{
    template<class FormatContext>
    auto format(kmpkg::StringView sv, FormatContext& ctx) const -> decltype(ctx.out())
    {
...
template<class Char>
struct fmt::range_format_kind<kmpkg::ZStringView, Char>
    : std::integral_constant<fmt::range_format, fmt::range_format::disabled>
{
};

KMPKG_FORMAT_AS(kmpkg::ZStringView, kmpkg::StringView);

template<class Char>
struct fmt::range_format_kind<kmpkg::StringLiteral, Char>
    : std::integral_constant<fmt::range_format, fmt::range_format::disabled>
{
};

KMPKG_FORMAT_AS(kmpkg::StringLiteral, kmpkg::StringView);
