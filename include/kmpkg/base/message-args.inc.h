...
DECLARE_MSG_ARG(command_line, "kmpkg install zlib")
...
DECLARE_MSG_ARG(cmake_var, "KMPKG_POLICY_EMPTY_PACKAGE")
DECLARE_MSG_ARG(elapsed, "3.532 min")
DECLARE_MSG_ARG(env_var, "KMPKG_DEFAULT_TRIPLET")
...
DECLARE_MSG_ARG(url, "https://github.com/kumose/kmpkg")
DECLARE_MSG_ARG(kmpkg_line_info, "/a/b/foo.cpp(13)")
