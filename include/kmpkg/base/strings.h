...
#include <kmpkg/base/to-string.h>
...
namespace kmpkg::Strings
{
    ...
    struct kmpkg_searcher
    {
        kmpkg_searcher(std::string::const_iterator first, std::string::const_iterator last) : impl(first, last) { }
    ...
    struct kmpkg_searcher
    {
        kmpkg_searcher(std::string::const_iterator first, std::string::const_iterator last)
    ...
    bool contains_any_ignoring_c_comments(const std::string& source, View<kmpkg_searcher> to_find);

    bool contains_any_ignoring_hash_comments(StringView source, View<kmpkg_searcher> to_find);

    bool long_string_contains_any(StringView source, View<kmpkg_searcher> to_find);
