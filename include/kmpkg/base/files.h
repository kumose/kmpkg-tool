...
#include <kmpkg/base/fwd/diagnostics.h>
...
#include <kmpkg/base/file-contents.h>
...
namespace kmpkg
{
    ...
    struct ReadOnlyFilesystem : ILineReader
    {
        ...
        // https://github.com/kumose/kmpkg/issues/16614 (canonical breaking on some older Windows Server containers)
        // https://github.com/kumose/kmpkg/issues/18208 (canonical removing subst despite our recommendation to use
        // subst)
    ...
    struct Filesystem : ReadOnlyFilesystem
    {
        ...
        // instances of kmpkg may be trying to do the same action at the same time.
        //
...
KMPKG_FORMAT_AS(kmpkg::Path, kmpkg::StringView);
