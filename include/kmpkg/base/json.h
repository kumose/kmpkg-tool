...
namespace kmpkg::Json
{
    struct JsonStyle
    {
        ...
        {
            kmpkg::Checks::check_exit(KMPKG_LINE_INFO, indent != SIZE_MAX);
    ...
    public:
        ...
        {
            kmpkg::Checks::check_exit(KMPKG_LINE_INFO, idx < this->size());
    ...
    public:
        ...
        Value& operator[](StringView key) noexcept
        {
            ...
            if (res == nullptr)
            {
                Checks::unreachable(KMPKG_LINE_INFO, fmt::format("JSON object missing key {}", key));
            }
