...
#include <kmpkg/base/background-work-queue.h>
...
namespace kmpkg
{
    ...
    struct ReadOnlyBinaryCache
    {
        ...
        // more than once in a single invocation of kmpkg.
    ...
    {
        bool install_providers(const KmpkgCmdArguments& args, const KmpkgPaths& paths, MessageSink& status_sink);
